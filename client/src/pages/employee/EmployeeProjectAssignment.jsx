...
const EmployeeProjectAssignment = () => {
    ...
    const loadProject = async () => {
        try {
            ...
            setCanManageAssignments(res.data.canManageAssignments === true);
        } catch (error) {
    ...
    if (!project) {
        return (
            <div className="project-details">
                <Link className="back-link" to="/employee/projects">
                    ← Back to Projects
                </Link>
        ...
        return (
            <div className="project-details">
                ...
                <p style={{ color: "#94a3b8", marginTop: "10px" }}>
                    Only Project Leads can access resource allocation & employee assignment management.
                </p>
            </div>
        );
    }
...
export default EmployeeProjectAssignment;
